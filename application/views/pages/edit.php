        ...
        <div class="col-8 ">
            ...
            <form action="" method="post">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="nama" name="nama" placeholder="Nama Poduk" value="<?= $produk['nama_produk'] ?>">
                    <small class="form-text text-danger"><?= form_error('nama'); ?></small>

                </div>
                <div class="mb-3">
                    <label for="keterangan" name="keterangan" class="form-label">Keterangan</label>
                    <input type="text" class="form-control" id="keterangan" name="keterangan" placeholder="keterangan Produk" value="<?= $produk['keterangan'] ?>">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="jumblah" name="jumblah" placeholder="Jumblah Produk" value="<?= $produk['jumblah'] ?>">
